...
<div id="basis">
    ...
    <table border='1'>
        ...
        $queryadres = 'SELECT `id`,`cad_num`,`adres`,`type`,`area`,`liter`,`name`,`new_adres`,`kod_kladr` FROM `gkn_zu_kladr_new` WHERE `id`>=' . $selectnumb . ' limit 1000';//and `id`<1200000
